...
| `mala-pata-walkthrough` | De un PR/change o un roadmap: recorrido de prueba en Given/When/Then → dos carriles (QA/UAT interno + doc how-to para cliente final), sin mezclarlos (Diátaxis + BDD). |
